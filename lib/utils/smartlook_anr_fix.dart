...
class SmartlookANRFix {
  ...
  static Future<void> safeTrackEvent(String eventName, {Map<String, dynamic>? properties}) async {
...
mixin SmartlookANRPrevention {
  ...
  Future<void> safeTrackEvent(String eventName, {Map<String, dynamic>? properties}) async {
