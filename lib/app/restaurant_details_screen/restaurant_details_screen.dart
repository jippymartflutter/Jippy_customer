                                  ...
                                  child: TweenAnimationBuilder<double>(
                                    ...
                                    builder: (context, value, child) {
                                      return Transform.scale(
                                        scale: controller.isOfferFilter.value ? 1.0 : value,
                                        child: AnimatedContainer(
                                          duration: Duration(milliseconds: 300),
                                          curve: Curves.easeInOut,
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 8, vertical: 6),
                                          decoration: controller.isOfferFilter.value
                                              ? BoxDecoration(
                                                  gradient: LinearGradient(
                                                    colors: [
                                                ...
                                                : BoxDecoration(
                                                    gradient: LinearGradient(
                                                      colors: themeChange.getThem()
                                                          ? [
                                                              Color(0xFFFF6B6B).withOpacity(0.15), // Subtle coral
                                                              Color(0xFFFF8E53).withOpacity(0.1),  // Subtle orange
                                                            ]
                                                          : [
                                                              Color(0xFFFF6B6B).withOpacity(0.08), // Very subtle coral
                                                              Color(0xFFFF8E53).withOpacity(0.05), // Very subtle orange
                                                            ],
                                                      begin: Alignment.topLeft,
                                                      end: Alignment.bottomRight,
                                                    ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Icon(
                                                Icons.local_offer,
                                                size: 16,
                                                color: controller.isOfferFilter.value
                                                    ? Colors.white
                                                    : Color(0xFFFF6B6B),
                                              ),
                                              const SizedBox(width: 4),
                                              Text(
                                                ...
                                                style: TextStyle(
                                                  ...
                                                  fontWeight: FontWeight.w600,
                                                  fontSize: 12,
                                                  shadows: controller.isOfferFilter.value
                                                      ? [
                                                          Shadow(
                                  ...
                                  builder: (context) {
                                    try {
                                      return Obx(() {
                                        ...
                                        final hasActiveFilters = (controller.isVag.value ?? false) || 
                                                                (controller.isNonVag.value ?? false) || 
                                                                (controller.isOfferFilter.value ?? false) ||
                                      ...
                                      print('Error building clear filter button: $e');
                                      return const SizedBox.shrink();
                                    }
                                  },
                                ),
...
class ProductListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print("DEBUG: ProductListView build - Categories: ${controller.vendorCategoryList.length}, Products: ${controller.productList.length}");
    ...
    return Container(
      ...
      child: controller.productList.isEmpty
          ...
          : controller.vendorCategoryList.isEmpty 
              ? _buildProductsWithoutCategories(context, themeChange, controller)
              : ListView.builder(
        shrinkWrap: true,
        ...
        itemBuilder: (context, index) {
          ...
          print("DEBUG: Building category: ${vendorCategoryModel.title} with ${controller.getProductsByCategory(vendorCategoryModel.id.toString()).length} products");
          ...
          return ExpansionTile(
            ...
            children: [
              Obx(
                    () => ListView.builder(
                  itemCount: controller.getProductsByCategory(vendorCategoryModel.id.toString()).length,
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                  padding: EdgeInsets.zero,
                  itemBuilder: (context, index) {
                    ProductModel productModel = controller.getProductsByCategory(vendorCategoryModel.id.toString())[index];
                                  ...
                                  children: [
                                    ...
                                    Builder(
                                      builder: (context) {
                                        ...
                                        final promoPrice = hasPromo ? (promo!['special_price'] as num).toString() : null;
                                        ...
                                        if (hasPromo) {
                                          ...
                                          return Row(
                                            children: [
                                              ...
                                              Flexible(
                                                child: Text(
                                                  Constant.amountShow(amount: Constant.productCommissionPrice(
                                                      controller.vendorModel.value,
                                                      productModel.price.toString())),
                                                  maxLines: 1,
                                                  overflow: TextOverflow.ellipsis,
                            ...
                            children: [
                              ...
                              Builder(
                                builder: (context) {
                                  ...
                                  print('[DEBUG] Product ${productModel.id} - Promotion data: $promo');
                                  if (promo != null) {
                                    print('[DEBUG] Showing SPECIAL badge for product ${productModel.id}');
                                    print('[DEBUG] Badge will be rendered with black background and white text');
                                    return Positioned(
                                      top: 0,
                                      left: 0,
                    ...
                    Expanded(
                      ...
                      child: isItemAvailable
                          ? FutureBuilder<String>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return RoundedButtonFill(
                                  title: "${'Add item'.tr} ${Constant.amountShow(amount: price)}".tr,
                                  height: 5.5,
                                  color: AppThemeData.primary300,
                                  textColor: AppThemeData.grey50,
                                  fontSizes: 16,
                        onPress: () async {
                          ...
                          if (productModel.itemAttribute == null) {
                            // Check for promotional price
                            String finalPrice = Constant.productCommissionPrice(
                                controller.vendorModel.value,
                                productModel.price.toString());
...
Widget _buildProductsWithoutCategories(BuildContext context, DarkThemeProvider themeChange, RestaurantDetailsController controller) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      FutureBuilder<Map<String, dynamic>?>(
                        future: Future.value(controller.getActivePromotionForProduct(
                          productId: productModel.id ?? '',
                          restaurantId: productModel.vendorID ?? '',
                        )),
                        builder: (context, promoSnapshot) {
                          final hasPromo = promoSnapshot.data != null;
                          final promoPrice = hasPromo ? (promoSnapshot.data!['special_price'] as num).toString() : null;
            ...
            Stack(
              children: [
                ...
                FutureBuilder<Map<String, dynamic>?>(
                  ...
                  builder: (context, promoSnapshot) {
                    print('[DEBUG] Product ${productModel.id} - Promotion data: ${promoSnapshot.data}');
                    if (promoSnapshot.data != null) {
                      print('[DEBUG] Showing SPECIAL badge for product ${productModel.id}');
                      print('[DEBUG] Badge will be rendered with black background and white text');
                      return Positioned(
                ...
                controller.isOpen.value == false ||
                  ...
                  child: isItemAvailable
                    ...
                    AppThemeData.primary300,
                        ...
                        controller.update();
                        controller.calculatePrice(productModel).then((_) {
                          controller.update();
                        });
                        // productDetailsBottomSheet(
                        //     context,
                          ...
                          Flexible(
                            child: Padding(
                                ...
                                child: Text(
                                  ...
                                  maxLines: 1,
                                  style: TextStyle(
                                    fontSize: cartItem.where((p0) => p0.id == productModel.id).first.quantity.toString().length > 2 ? 12 : 16,
                                    overflow: TextOverflow.ellipsis,
                                    fontFamily: AppThemeData.medium,
                                    fontWeight: FontWeight.w500,
                                    color: themeChange.getThem() ? AppThemeData.grey100 : AppThemeData.grey800,
...
Widget _buildNoProductsMessage(BuildContext context, DarkThemeProvider themeChange) {
  return Container(
