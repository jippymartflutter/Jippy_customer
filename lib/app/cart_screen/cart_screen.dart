                                      ...
                                      if (addressModel.location?.latitude !=
                                        ...
                                        try {
                                          ...
                                          if (Constant.selectedZone != null) {
                                            ...
                                            final zoneId = await MartZoneUtils
                        ...
                        child: Padding(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              dev.log(
                                  'cartItem[index] :: ${cartProductModel.extras} ::${cartProductModel.extrasPrice}');
                              Widget priceWidget;
                              if (cartProductModel.promoId != null &&
                                ...
                                priceWidget = Row(
                                  children: [
                                    ...
                                    if (cartProductModel.discountPrice !=
                                            null &&
                                                            ...
                                                            children: [
                                                              ...
                                                              InkWell(
                                                                onTap:
                                                                  ...
                                                                  if (productModel ==
                                                                      null) {
                                                                    productModel = await FireStoreUtils.getProductById(cartProductModel
                                                                        .id!
                                                                        .split(
                                                                            '~')
                                                                        .first);
                                                                  ...
                                                                  if (productModel !=
                                                                    ...
                                                                    if (productModel!
                                                                        ...
                                                                        .isNotEmpty) {
                                                                      if (int.parse(productModel!.itemAttribute!.variants!.where((element) => element.variantSku == cartProductModel.variantInfo!.variantSku).first.variantQuantity.toString()) >=
                                                                              (cartProductModel.quantity ??
                                                                                  0) ||
                                                                          int.parse(productModel!.itemAttribute!.variants!.where((element) => element.variantSku == cartProductModel.variantInfo!.variantSku).first.variantQuantity.toString()) ==
                                                                              -1) {
                                      ...
                                      : Row(
                                          ...
                                          children: [
                                            ...
                                            Obx(() {
                                              ...
                                              final threshold = controller
                                                      .deliveryChargeModel
                                                      .value
                                                      .itemTotalThreshold ??
                                                  299;
                                              final freeKm = controller
                                                      .deliveryChargeModel
                                                      .value
                                              ...
                                              print(
                                                  '[CART_UI]   - Subtotal: ₹$subtotal');
                                              print(
                                                  '[CART_UI]   - Threshold: ₹$threshold');
                                              print(
                                                  '[CART_UI]   - Distance: ${distance} km');
                                              print(
                                                  '[CART_UI]   - Free distance: ${freeKm} km');
                                              print(
                                                  '[CART_UI]   - Delivery charges: ₹${controller.deliveryCharges.value}');
                                              print(
                                                  '[CART_UI]   - Original delivery fee: ₹${controller.originalDeliveryFee.value}');
                                              ...
                                              if (isAboveThreshold) {
                                                ...
                                                if (isWithinFreeDistance) {
                                                  // Standard free delivery: Green "Free Delivery" + strikethrough base charge + ₹0.00
                                                  print(
                                                      '[CART_UI]   - Standard free delivery');
                                                  return _buildDeliveryFeeUI(
                                                    isFreeDelivery: true,
                                                    originalFee:
                          ...
                          child: Row(
                            ...
                            children: [
                              controller.selectedPaymentMethod.value == ''
                                  ? cardDecoration(controller,
                                      PaymentGateway.wallet, themeChange, "")
                                  : controller.selectedPaymentMethod.value ==
                      ...
                      Expanded(
                        child: RoundedButtonFill(
                          textColor: AppThemeData
                              .surface, // Always use primary text color
                          isEnabled:
                          ...
                          height: 5,
                          color: AppThemeData
                              .primary300, // Always use primary color
                          fontSizes: 16,
                          onPress: () async {
                            ...
                            if (controller.isProcessingOrder.value) {
                              ShowToastDialog.showToast(
                                  "Please wait, order is being processed..."
                                      .tr);
                              return;
                            }
                            ...
                            print(
                                '💰 [PAYMENT_FLOW] Payment method: ${controller.selectedPaymentMethod.value}');
                            print(
                                '💰 [PAYMENT_FLOW] Cart items: ${cartItem.length}');
                            print(
                                '💰 [PAYMENT_FLOW] Total amount: ₹${controller.totalAmount.value}');
                            print(
                                '💰 [PAYMENT_FLOW] Starting bulletproof validation...');

                            final validationStartTime = DateTime.now();
                            final canProceed = await controller
                                .validateAndPlaceOrderBulletproof();
                            final validationDuration =
                                DateTime.now().difference(validationStartTime);

                            print(
                                '💰 [PAYMENT_FLOW] Bulletproof validation completed in ${validationDuration.inMilliseconds}ms');

                            if (!canProceed) {
                              print(
                                  '💰 [PAYMENT_FLOW] ❌ VALIDATION FAILED - PAYMENT BLOCKED');
                              print(
                                  '💰 [PAYMENT_FLOW] User must complete validation before proceeding');
                              print(
                                  '💰 [PAYMENT_FLOW] ==========================================');
                              return;
                            }
                            ...
                            print(
                                '💰 [PAYMENT_FLOW] ✅ VALIDATION PASSED - PROCEEDING WITH PAYMENT');
                            print(
                                '💰 [PAYMENT_FLOW] Payment method: ${controller.selectedPaymentMethod.value}');
                            print(
                                '💰 [PAYMENT_FLOW] ==========================================');
