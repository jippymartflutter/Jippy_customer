...
class HomeScreenTwo extends StatelessWidget {
  ...
  static Future<void> _checkMartAvailability() async {
    try {
      ...
      print('📍 [HOME_SCREEN_TWO] Current Zone: ${Constant.selectedZone?.id ?? "NULL"} (${Constant.selectedZone?.name ?? "NULL"})');
      print('📍 [HOME_SCREEN_TWO] User Location: ${Constant.selectedLocation.location?.latitude ?? "NULL"}, ${Constant.selectedLocation.location?.longitude ?? "NULL"}');
      ...
      if (martVendors.isEmpty) {
        print('❌ [HOME_SCREEN_TWO] No mart vendors in zone - Showing COMING SOON dialog');
        ...
        if (isMartTemporarilyClosed) {
          print('⚠️ [HOME_SCREEN_TWO] Mart is temporarily closed - Showing MART AVAILABLE dialog');
          ...
          print('✅ [HOME_SCREEN_TWO] Mart is available and open - Navigating to MartNavigationScreen');
          print('🎯 [HOME_SCREEN_TWO] Navigation: HomeScreenTwo -> MartNavigationScreen');
      ...
      print('🚀 [HOME_SCREEN_TWO] ===== MART NAVIGATION COMPLETED (ERROR) =====\n');
    }
  }
        ...
        return Scaffold(
          ...
          floatingActionButton: Stack(
            children: [
              ...
              Positioned(
                bottom: cartItem.isNotEmpty ? 100 : 16, // Position above mini cart if active, otherwise at bottom
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        controller.storyList.isEmpty ||
                                                (Constant.storyEnable == false && !kDebugMode)
                                            ? Column(
                                                children: [
                                                  // Debug information
                                                  if (kDebugMode) ...[
                                                    Container(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          SizedBox(height: 8),
                                                          Text('Story List Empty: ${controller.storyList.isEmpty}'),
                                                          Text('Story Enable: ${Constant.storyEnable}'),
                                                          Text('Story Count: ${controller.storyList.length}'),
                                                          Text('Story Enable Value: ${Constant.storyEnable}'),
                                                        ],
                                                      ),
                                                    ),
                                                  ],
